...
@section('page_title', 'Thêm thể loại phim')
@section('page_subtitle', 'Tạo mới một thể loại cho phim')
    ...
    <form action="{{ route('admin.genres.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input id="genre-name" type="text" name="name"
                   value="{{ old('name') }}" class="genre-input">
        </div>
        ...
        <div>
            ...
            <input id="genre-slug" type="text" name="slug"
                   value="{{ old('slug') }}" class="genre-input"
        ...
        <div>
            ...
            <textarea name="description" rows="4"
                      ...
                      placeholder="Mô tả ngắn về thể loại này...">{{ old('description') }}</textarea>
        </div>
