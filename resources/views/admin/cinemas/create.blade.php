...
@section('page_title', 'Thêm rạp chiếu')
@section('page_subtitle', 'Tạo mới một rạp chiếu phim')
    ...
    <form action="{{ route('admin.cinemas.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="name"
                   value="{{ old('name') }}"
                   class="cinema-input"
                   placeholder="VD: Laravel Cinema Cầu Giấy">
        </div>
        ...
        <div>
            ...
            <p class="cinema-hint mt-1">
                Địa chỉ chi tiết để hiển thị cho khách khi đặt vé.
            </p>
        </div>
